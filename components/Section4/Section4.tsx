...
function Section4() {
  return (
    ...
    <div className={styles.one}>
        <h1 className={styles.head_one}><i>Explore Accessories</i></h1>
    </div>
    
    <div className={styles.two}>
        <div className={styles.card}>
            <Image src={'/images/accessories-1.jpg'} alt='one' height={180} width={270}/>
        ...
        <div className={styles.card}>
            <Image src={'/images/accessories-2.jpg'} alt='two' height={180} width={270}/>
            <p className={styles.nam}>Accessories</p>
        ...
        <div className={styles.card}>
            <Image src={'/images/accessories-3.jpg'} alt='three' height={180} width={270}/>
            <p className={styles.nam}>Accessories</p>
        ...
        <div className={styles.card}>
            <Image src={'/images/accessories-4.jpg'} alt='four' height={180} width={270}/>
            <p className={styles.nam}>Accessories</p>
        ...
        <div className={styles.last_div}>
            <button className={styles.last_btn} type="button">VIEW ALL</button>
        </div>
